 ...
 *             'targets' => [
 *                 'file' => [
 *                     'class' => 'ucs\log\FileTarget',
 *                     'levels' => ['trace', 'info'],
 *                     'categories' => ['ucs\*'],
 *                 ],
 *                 'email' => [
 *                     'class' => 'ucs\log\EmailTarget',
    ...
    public function init()
    {
        ...
        foreach ($this->targets as $name => $target) {
            if (!$target instanceof Target) {
                $this->targets[$name] = Uii::createObject($target);
            }
        }
    }
