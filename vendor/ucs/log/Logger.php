...
class Logger extends Component
{
     ...
     * For example, 'ucs\db\*' will match categories starting with 'ucs\db\',
     * such as 'ucs\db\Connection'.
    ...
    {
        $timings = $this->getProfiling(['ucs\db\Command::query', 'ucs\db\Command::execute']);
        $count = count($timings);
        $time = 0;
