...
abstract class Target extends Component
{
     ...
     * match those categories sharing the same common prefix. For example, 'ucs\db\*' will match
     * categories starting with 'ucs\db\', such as 'ucs\db\Connection'.
     */
    public $categories = [];
    /**
     ...
     *
     * @see \ucs\helpers\ArrayHelper::filter()
     */
    ...
    public function getMessagePrefix($message)
    {
        ...
        $request = Uii::$app->getRequest();
        $ip = $request instanceof Request ? $request->getUserIP() : '-';

        /* @var $user \ucs\web\User */
        $user = Uii::$app->has('user', true) ? Uii::$app->get('user') : null;
        ...
        /* @var $session \ucs\web\Session */
        $session = Uii::$app->has('session', true) ? Uii::$app->get('session') : null;
