...
class ArrayHelper
{
     ...
     * ```php
     * // working with array
     * $username = \ucs\helpers\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = \ucs\helpers\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = \ucs\helpers\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = \ucs\helpers\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = \ucs\helpers\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
     ...
     * // working with array
     * $type = \ucs\helpers\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * [[\ucs\base\Application::charset]] will be used.
