...
class StringHelper
{
    ...
    public static function startsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, 0, $bytes, '8bit'), static::$encoding) === mb_strtolower($with, static::$encoding);
        }
    }
    ...
    public static function endsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, -$bytes, mb_strlen($string, '8bit'), '8bit'), static::$encoding) === mb_strtolower($with, static::$encoding);
        }
    }
