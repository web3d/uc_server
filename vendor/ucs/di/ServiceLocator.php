 ...
 *
 * ```php
 * $locator = new \ucs\di\ServiceLocator;
 ...
 * ```
 *
 * Because [[\ucs\base\Module]] extends from ServiceLocator, modules and the application are all service locators.
 *
...
class ServiceLocator extends Component
{
    ...
    public function get($id, $throwException = true)
    {
        ...
        if (isset($this->_definitions[$id])) {
            ...
            if (is_object($definition) && !$definition instanceof Closure) {
                ...
                return $this->_components[$id] = Uii::createObject($definition);
            }
     ...
     * ```php
     * // a class name
     * $locator->set('cache', 'ucs\caching\FileCache');
     *
     ...
     *     return new \ucs\caching\FileCache;
     * });
     *
     * // an instance
     * $locator->set('cache', new \ucs\caching\FileCache);
     * ```
     *
