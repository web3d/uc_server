 ...
 * $container->set('ucs\db\Connection', [
 *     'dsn' => '...',
 * ]);
...
class Container extends Component
{
     ...
     *
     * If the class implements [[\ucs\base\Configurable]], the `$config` parameter will be passed as the last
     ...
     * $container->set('ucs\mail\MailInterface', 'ucs\swiftmailer\Mailer');
     *
     * // register an alias name. You can use $container->get('foo')
     * // to create an instance of Connection
     * $container->set('foo', 'ucs\db\Connection');
     *
     ...
     *     return new \ucs\db\Connection($config);
     * });
     * ```
     *
    ...
    protected function build($class, $params, $config)
    {
        ...
        if (!empty($dependencies) && $reflection->implementsInterface('ucs\base\Configurable')) {
     ...
     *
     * ```php
     * $formatString = function($string, \ucs\i18n\Formatter $formatter) {
     *    // ...
     * }
    ...
    public function resolveCallableDependencies(callable $callback, $params = [])
    {
        ...
        foreach ($reflection->getParameters() as $param) {
            ...
            if (($class = $param->getClass()) !== null) {
                ...
                } elseif (isset(Uii::$app) && Uii::$app->has($name) && ($obj = Uii::$app->get($name)) instanceof $className) {
                    $args[] = $obj;
                } else {
