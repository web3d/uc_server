...
class ColumnSchemaBuilder extends Object
{
    ...
    /**
     * @var \ucs\db\Connection the current database connection. It is used mainly to escape strings
     ...
     * @param \ucs\db\Connection $db the current database connection. See [[$db]].
