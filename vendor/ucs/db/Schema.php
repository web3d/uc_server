...
use ucs\base\InvalidCallException;
use ucs\caching\Cache;
use ucs\caching\TagDependency;
...
abstract class Schema extends Object
{
     ...
     */
    public $exceptionMap = [
        'SQLSTATE[23' => 'ucs\db\IntegrityException',
    ];
    ...
    /**
     * @return \ucs\db\ColumnSchema
     * @throws \ucs\base\InvalidConfigException
     */
    protected function createColumnSchema()
    {
        return Uii::createObject('ucs\db\ColumnSchema');
    }
    ...
    public function convertException(\Exception $e, $rawSql)
    {
        ...
        $exceptionClass = '\ucs\db\Exception';
