...
class control extends adminbase
{
    ...
    function ondetail()
    {
            ...
            if (getgpc('apppath', 'P')) {
                ...
                if ($app['extra']['apppath']) {
                    ...
                    if (! file_exists($apifile)) {
                        $this->message('app_apifile_not_exists', 'BACK', 0, array(
                            '$apifile' => $apifile
                        ));
                    }
                    ...
                    if (! $uc_client_version || $uc_client_version <= '1.0.0') {
                        $this->message('app_apifile_too_low', 'BACK', 0, array(
                            '$apifile' => $apifile
                        ));
                    }
                } else {
        ...
        $synloginchecked = array(
            $app['synlogin'] => 'checked="checked"'
        );
        $recvnotechecked = array(
            $app['recvnote'] => 'checked="checked"'
        );
